...
public class BoardController {
   ...
   // 나머지값 //currentPage값
   public String writeProMethod(BoardDTO dto, PageDTO pv, HttpServletRequest request) {// 3
      // String이기 때문에 varchar2로 변환후 사용
   ...
   private UUID saveCopyFile(MultipartFile file, HttpServletRequest request) { // 2
   ...
   private String urlPath(HttpServletRequest request) { // 1
      String root = request.getSession().getServletContext().getRealPath("/");
      // D:\bit-study\spring_workspace\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\spring_08_board
